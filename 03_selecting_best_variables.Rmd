...
```{r Millennium-Simulation-Project, echo=FALSE, out.width="200px",fig.cap="위에서와 같이, 아래에서도", out.extra=""}
...
```{r ranking-best-vars-comparison, echo=FALSE, fig.cap="다른 변수 순위 비교", out.extra=""}
...
```{r variables-work-in-groups, echo=FALSE, out.width="54%", fig.cap="변수는 그룹으로 작용합니다", out.extra=""}
...
```{r selecting-best-variables-5, echo=FALSE, out.width="54%", fig.cap="아리스토텔레스 (기원전 384년 – 기원전 322년)", out.extra=""}
...
4개의 행, 2개의 입력 변수(`var_1`, `var_2`), 그리고 하나의 결과(`target`)를 가진 다음과 같은 _빅 데이터_ 테이블 `r emo::ji("stuck_out_tongue_winking_eye")`을 보십시오.

```{r variables-work-in-groups-2, echo=FALSE, out.width="200px", fig.cap="뭉쳐야 산다: 변수 결합", out.extra=""}
...
우리는 ... _"세상에! 우산이 필요한 거야 아니야 `r emo::ji("scream")`?"_라고 생각할 것입니다.
...
```{r variable-ranking-using-information-theory, fig.width=6, fig.height=4.5, tidy=FALSE, fig.cap="변수 중요도 (이득률 기준)", out.extra=""}
variable_importance = 
...
```{r fractals-nature, echo=FALSE, out.width="38%", fig.cap="자연 속의 프랙탈", out.extra=""}
...
```{r variable-selection-in-r-2, echo=FALSE, fig.cap="서로 다른 변수 부분 집합에 대한 ROC 값", out.extra=""}
...
```{r variable-selection-in-clustering, echo=FALSE, out.width="54%", fig.cap="클러스터 세분화의 예", out.extra=""}
...
```{r cross-plot-data-viz, results="hide", fig.height=4, fig.width=9.5, fig.cap="변수 중요도를 분석하고 보고하기 위한 cross-plot 사용", out.extra=""}
...
```{r cross-plot-feature-engineering, results="hide",  message=FALSE,fig.height=4, fig.width=9.5, fig.cap="입력으로 수치형 변수 사용 (자동 구간화)", out.extra=""}
...
```{r selecting-best-variables-3, results="hide", fig.height=4, fig.width=9.5,fig.cap="자동 구간화를 비활성화하면 원래 변수가 표시됩니다", out.extra=""}
...
```{r variable-importance-c5, results="hide",fig.height=4, fig.width=9.9, tidy=FALSE,fig.cap="커스텀 구간화를 사용한 시각화", out.extra=""}
...
```{r feature-engineering, results="hide", fig.height=4, fig.width=9.5, tidy=FALSE, fig.cap="구간을 줄이면 관계를 더 잘 드러내는 데 도움이 될 수 있습니다", out.extra=""}
...
```{r several-cross-plot-c1, eval=FALSE, fig.cap="쉬운 플롯 추출", out.extra=""}
...
```{r several-cross-plot-c3, eval=FALSE, fig.cap="여러 변수를 한 번에 쉽게 분석하기", out.extra=""}
...
```{r variable-importance2b,  fig.height=3, fig.width=5, fig.cap="박스 플롯을 사용한 타겟 프로파일링", out.extra=""}
...
```{r boxplot-analysis, echo=FALSE, out.width="85%", fig.cap="박스 플롯 해석 방법", out.extra=""}
...
```{r variable-importance2e,  fig.height=3, fig.width=5, fig.cap="여러 변수에 대한 plotar 함수", out.extra=""}
...
```{r variable-importance1, results='hide',  fig.height=3, fig.width=5, fig.cap="밀도 히스토그램을 사용한 타겟 프로파일링", out.extra=""}
...
```{r variable-importance2,  fig.height=2, fig.width=5, fig.cap="여러 변수에 대한 plotar 함수", out.extra=""}
