--- 
---
# title, author, date, bibliography, description, url 등은 _quarto.yml에서 관리
# site, output, github-repo는 Bookdown 관련 설정이므로 제거
# classoption, linestretch, linkcolor, links-as-notes는 필요시 _quarto.yml의 format 설정으로 이동 가능
# favicon은 _quarto.yml의 html: favicon 설정으로 이동 가능
# cover-image는 _quarto.yml의 book: cover-image 또는 각 format의 cover-image로 이동
# biblio-style은 _quarto.yml의 biblio-style로 이동
# link-citations는 Quarto에서 기본적으로 지원하거나 citation-processing 관련 옵션으로 제어
---
